                ...
                { 
                    ...
                    if($query->rowCount() > 0)
                    {
                        ...
                        {            
                            ...
                            { 
                                echo "<script>
                                alert('Your company account is not active, you will receive notification after verifcation _ thank you');document.location ='index.php';
                                </script>";
                            }
                        } 
                    }                  
                    ...
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left p-5">
                            <div class="brand-logo" align="center">
                                <img class="img-avatar mb-3" src="companyimages/hostel_logo.jpg" alt="company logo">
                            </div>
