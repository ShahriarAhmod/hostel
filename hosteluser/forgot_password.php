...
{ 
  ...
  }else
  {
    ...
    $sql ="SELECT email FROM userregistration WHERE email=:email and contactNo=:mobile";
    ...
    if($query -> rowCount() > 0)
    {
      $con="update userregistration set password=:newpassword where email=:email and contactNo=:mobile";
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left p-5">
              <div class="brand-logo " align="center" >
                <img class="img-avatar mb-3" src="companyimages/hostel_logo.jpg" alt=""> <br>
